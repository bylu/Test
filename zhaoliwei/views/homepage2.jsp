...
<head>
    ...
    -->
    <link rel="stylesheet" href="resource/css/skins/skin-blue.min.css">
...
<!-- jQuery 2.1.4 -->
<script src="resource/js/lib/jQuery-2.1.4.min.js"></script>
<!-- Bootstrap 3.3.5 -->
<script src="resource/js/lib/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="resource/js/lib/app.min.js"></script>
<!-- 自定义工具类 -->
